...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['room_name', '-timestamp'], name='chat_chatme_room_na_485155_idx'), models.Index(fields=['receiver', 'is_read'], name='chat_chatme_receive_d79e66_idx')],
            },
        ),
        migrations.CreateModel(
            name='Friendship',
